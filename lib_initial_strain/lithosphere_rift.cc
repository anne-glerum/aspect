...
namespace aspect
{
  namespace InitialTemperature
  {
    ...
    initial_temperature (const Point<dim> &position) const
    {
      ...
      const double depth = this->get_geometry_model().depth(position) - air_thickness;

      // tmp for testing
      std::vector<double> tmp_thick(3);
      tmp_thick[0]=20e3;
      tmp_thick[1]=15e3;
      tmp_thick[2]=85e3;
//      std::cout << "T at 5 km for default thicknesses " << temperature(5e3,tmp_thick) << std::endl;
//      std::cout << "T at 25 km for default thicknesses " << temperature(25e3,tmp_thick) << std::endl;
//      std::cout << "T at 55 km for default thicknesses " << temperature(55e3,tmp_thick) << std::endl;
//      std::cout << "T at 105 km for default thicknesses " << temperature(105e3,tmp_thick) << std::endl;
//      std::cout << "T at 115 km for default thicknesses " << temperature(115e3,tmp_thick) << std::endl;
//      std::cout << "T at 119 km for default thicknesses " << temperature(119e3,tmp_thick) << std::endl;
//      std::cout << "T at 120 km for default thicknesses " << temperature(120e3,tmp_thick) << std::endl;
                 ...
                 const std::vector<double> layer_thicknesses) const
    {
      ...
      //std::cout << "Upper/lower crust T " << T1 << ", Moho T " << T2 << " for thicknesses " << layer_thicknesses[0] << ", " << layer_thicknesses[1] << ", " << layer_thicknesses[2] << std::endl;

      // Temperature in the air
      if (depth < 0)
        return T0;
      // Temperature in layer 1
      else if (depth < layer_thicknesses[0])
    ...
    LithosphereRift<dim>::parse_parameters (ParameterHandler &prm)
    {
      ...
      prm.enter_subsection ("Initial composition model");
      {
        prm.enter_subsection("Lithosphere with rift");
        {
          air_thickness        = prm.get_double ("Sticky-air layer thickness");
