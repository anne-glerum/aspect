    ...
    namespace Rheology
    {
      ...
      FrictionOptions<dim>::declare_parameters (ParameterHandler &prm)
      {
        prm.declare_entry ("Friction dependence mechanism", "none",
                           ...
                           "movement. At the moment the second invariant of the deviatoric strain rate is used "
                           "to determine rate dependence if the plastic damper is not used. If it is used, the "
                           "plastic strain rate is used for the calculation of friction. "
                           "\n\n"
