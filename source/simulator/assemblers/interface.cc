    ...
    namespace Assembly
    {
      namespace Scratch
      {
        ...
        AdvectionSystem (const FiniteElement<dim> &finite_element,
          ...
          old_mesh_velocity_values (quadrature.size(), numbers::signaling_nan<Tensor<1,dim> >()),
          old_old_mesh_velocity_values (quadrature.size(), numbers::signaling_nan<Tensor<1,dim> >()),
        ...
        AdvectionSystem (const AdvectionSystem &scratch)
          ...
          old_mesh_velocity_values (scratch.old_mesh_velocity_values),
          old_old_mesh_velocity_values (scratch.old_old_mesh_velocity_values),
