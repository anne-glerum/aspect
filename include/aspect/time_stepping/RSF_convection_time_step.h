...
#ifndef _aspect_time_stepping_RSF_convection_time_step_h
#define _aspect_time_stepping_RSF_convection_time_step_h
...
namespace aspect
{
  namespace TimeStepping
  {
     ...
     */
    template <int dim>
    class RSFConvectionTimeStep : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
         * Constructor.
         */
        RSFConvectionTimeStep () = default;
