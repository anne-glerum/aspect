...
#ifndef _aspect_particle_property_theta_for_RSF_h
#define _aspect_particle_property_theta_for_RSF_h
...
namespace aspect
{
  namespace Particle
  {
    ...
    {
      /**
       * A class that calculates the state variable theta from rate-and-state friction
       * for a particle through time.
       * The implementation of this property is equivalent to the implementation
       * for compositional fields that is described in the friction options rheology
       * model.
       *
       * @ingroup ParticleProperties
       */
      template <int dim>
      class ThetaRSF : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
          * Constructor.
