...
#ifndef _aspect_particle_property_test_particle_update_h
#define _aspect_particle_property_test_particle_update_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class TestParticleUpdate : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
           ...
           * to their position and value from the beginning of the timestep.
