...
#ifndef _aspect_postprocess_free_surface_BC_h
#define _aspect_postprocess_free_surface_BC_h
...
namespace aspect
{
  namespace Postprocess
  {
    ...
    /**
     * A postprocessor that outputs the surface free_surface_BC to file.
     *
     * @ingroup Postprocessing
     */
    template <int dim>
    class FreeSurfaceBC : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
         * Output free_surface_BC [m] to file
         */
        virtual
      ...
      private:
        /**
         * Whether or not to produce text files with free_surface_BC values
         */
        bool write_to_file;
