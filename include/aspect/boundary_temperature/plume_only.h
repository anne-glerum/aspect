...
#ifndef _aspect_boundary_temperature_plume_only_h
#define _aspect_boundary_temperature_plume_only_h
  ...
  namespace BoundaryTemperature
  {
    ...
    class PlumeOnly : public Interface<dim>, public SimulatorAccess<dim>
    {
      ...
      private:
         ...
         * gplates files.
         */
        std::shared_ptr<internal::PlumeOnlyLookup<dim> > lookup;
