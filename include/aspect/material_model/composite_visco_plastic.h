...
#ifndef _aspect_material_model_composite_visco_plastic_h
#define _aspect_material_model_composite_visco_plastic_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class CompositeViscoPlastic : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
