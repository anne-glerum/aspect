...
#ifndef __aspect__geometry_model_layered_chunk_4_h
#define __aspect__geometry_model_layered_chunk_4_h
...
namespace aspect
{
  namespace GeometryModel
  {
     ...
     */
    template <int dim>
    class LayeredChunk4 : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
